...
namespace Barcode {
	...
	void GameState::_initWorld() {
		...
		}
		{
			...
			auto rbc = physicsBox->addComponent<Hydra::Component::RigidBodyComponent>();
			rbc->createBox(glm::vec3(0.5f), Hydra::System::BulletPhysicsSystem::CollisionTypes::COLL_MISC_OBJECT, 10);
