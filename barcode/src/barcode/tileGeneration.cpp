...
//}
//
//void tileGeneration::createMapRecursivly(tileInfo *tile) {
//
...
//									roomTile->addComponent<Hydra::Component::TransformComponent>(tiles[k]->middlePoint);
//									fits = true;
//								}
...
//
//							if (loadedRoom.get()->getComponent<Hydra::Component::RoomComponent>()->getRightDoor()) {
